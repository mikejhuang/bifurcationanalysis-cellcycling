...
dydt(3,1) = D+k3*AP+k23*E2F*J13*J63/((J13+RB)*(J63+RB1))+k43*CycD_a-k34*CycD*CycD_a/(Km4+CycD_a)-phi_CycD*CycD*E2F*2;
...
dydt(8,1) = C+k28*E2F*J18*J68/((J18+RB)*(J68+RB1))+k98*CycE_a-k89*CycE*CycE_a/(Km9+CycE_a)-phi_CycE*CycE*E2F*1;
