...
r(1,:,:)=result{1};r(2,:,:)=result{2};r(3,:,:)=result{3};r(4,:,:)=result{4};r(5,:,:)=result{5};
r(6,:,:)=result{6};r(7,:,:)=result{7};r(8,:,:)=result{8};r9=result{9};r10=result{10};
...
Stability_Low=[r(1,90,2),r(2,90,2),r3(90,2),r4(90,2),r5(90,2),r6(90,2),r7(90,2),r8(90,2),r9(90,2),r10(90,2),r11(90,2),r12(90,2),r13(90,2),r14(90,2),r15(90,2),r16(90,2),r17(90,2),r18(90,2),r19(90,2),r20(90,2)];
Stability_High=[r(1,1000,2),r(2,1000,2),r3(1000,2),r4(1000,2),r5(1000,2),r6(1000,2),r7(1000,2),r8(1000,2),r9(1000,2),r10(1000,2),r11(1000,2),r12(1000,2),r13(1000,2),r14(1000,2),r15(1000,2),r16(1000,2),r17(1000,2),r18(1000,2),r19(1000,2),r20(1000,2)];
